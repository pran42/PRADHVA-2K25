      ...
      <div className="max-w-4xl mx-auto bg-white bg-opacity-10 p-8 rounded-lg shadow-lg">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              The group games include <strong>Cricket</strong>,{" "}
              <strong>Football</strong>, <strong>Volleyball</strong>,{" "}
              <strong>Basketball</strong>, <strong>Throwball</strong>,{" "}
              <strong>Kho - Kho</strong> and <strong>Kabaddi</strong>.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              The athletic events for boys include <strong>100m</strong>,{" "}
              <strong>200m</strong>, <strong>400m</strong>,{" "}
              <strong>800m</strong>, and <strong>1500m</strong> races.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              Events include <strong>Shotput</strong>,{" "}
              <strong>Discus Throw</strong>, <strong>Javelin</strong>, and{" "}
              <strong>Long Jump</strong>.
            </li>
            <li>
              Results are based on the best of three attempts.{" "}
              <strong>Foul attempts</strong> count as chances.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              Matches up to the <strong>quarterfinals</strong>: 1 set of 15
              points.
            </li>
            <li>
              <strong>Quarterfinals onward</strong>: Best of 3 sets.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              Each student can participate in the following events:
              <ul className="list-decimal  ml-4">
                <li>
                  <strong>2 group games</strong>
                </li>
                <li>
                  <strong>2 indoor events</strong>
                </li>
                <li>
                  <strong>2 athletics events</strong>
                </li>
                <li>
                  <strong>2 field events</strong>
                </li>
                <li>
                  <strong>1 relay event</strong>
                </li>
                <li>
                  <strong>Badminton</strong> (separate from other events)
                </li>
              </ul>
            </li>
          </ul>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              <strong>No spot registrations</strong> will be permitted.
            </li>
            <li>
              Participants must arrive on time. Late arrivals (except for event
              clashes) result in disqualification.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              <strong>Decisions</strong> by referees and the committee are
              final. Arguing leads to warnings or disqualification.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              <strong>Misuse</strong> or tampering with sports equipment results
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              The organizing committee is not liable for injuries, though{" "}
              <strong>first aid</strong> will be available.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              Teams must notify the committee at least{" "}
              <strong>1 hour before</strong> the event if they are unable to
              compete.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc ">
            <li>
              In case of a <strong>tie</strong>, event-specific tiebreaker rules
              apply (e.g., additional set, time extension).
            </li>
          </ul>
        </section>
            ...
            <li>
              ...
              <ul className="list-disc ml-4">
                ...
                <li>
                  ...
                  <strong>
                    exceeds the allocation specified for that house
                  </strong>{" "}
                  (as listed above), preliminaries will be conducted.
                </li>
              </ul>
            </li>
            <li>
